...
def main():
    ...
    # -------------------------------------------------------------------------
    button1 = ttk.Button(frame1, text='Ayeeee')
    ...
    # -------------------------------------------------------------------------
    button1['command'] = lambda: do_print()
    ...
    #      n = int(s)
    ####################################################################
    frame3 = ttk.Frame(root,padding=30, relief='raised')
    frame3.grid()

    my_entry_box2 = ttk.Entry(frame3)
    my_entry_box2.grid()

    print_entry_button2 = ttk.Button(frame3, text='Integer')
    print_entry_button2['command'] = (lambda:
                                     print_contents2(my_entry_box2,my_entry_box))
...
def print_contents2(entry_box2, my_entry_box):
    s = entry_box2.get()
